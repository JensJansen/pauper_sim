"""Set Transformer encoder + FiLM conditioning over rl.model.features's
...
head -- those are per-deck (see rl.model.deck), not shared.
...
class SetTransformer(nn.Module):
    ...
    def forward(self, vocab_idx, features, key_padding_mask, side_flag):
        ...
        -- rl.model.features.build_token_set's own last feature column, passed
