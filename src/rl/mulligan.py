...
if __name__ == "__main__":
    # ponytail self-check: run via `python -m rl.mulligan` from src/.
    import random
    ...
    # 2) heads produce the right shapes and respect the bottom mask
    ...
    # 3) learning: a synthetic world where mulliganing (action=1) is GOOD -- keeping
    ...
    print("rl.mulligan self-check: OK "
          f"(mull-prob {p_mull_when_good:.2f} when mulligan wins -> {p_mull_when_bad:.2f} when keep wins)")
