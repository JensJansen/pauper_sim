...
Split out of rl/agent.py 2026-08-17: agent.py is the LEARNED path (feature
...
The dependency is one-way -- this module imports rl.agent, never the reverse --
...
import game
from rl.agent import (PREGAME_KINDS, AlwaysKeep, DecisionResult, _build_decision,
